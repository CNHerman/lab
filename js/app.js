...
$(document).ready(function(){   
	...
	//自定义弹幕
    // var mess = "<span class='B-span2'>须臾主页https://xinfaye.top</span><span>没想到新年马上就要到了</span><span class='B-span2'>祝你我新年快乐！</span><span>你好2022新的一年。</span>";
    // $(".Barrage").append(mess);
    ...
    $(".buts").click(function(){
        ...
        if(!mes){
          // alert("你还没输入内容呢!")
          var Tipss = "<div class='Tipss'>朋友，你还没输入内容呢</div>";
          $("body").append(Tipss);
          setTimeout(function(){
            $(".Tipss").remove();
          },1500)
